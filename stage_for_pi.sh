...
echo "  Copied rag.py, web.py, templates/ to $DEST_SCRIPTS/"
echo ""
...
echo "  $DEST_MODELS"
echo "  $DEST_HF"
echo "  $DEST_SCRIPTS/{rag.py,web.py,templates/}"
echo ""
echo "On the Pi — start Ollama, then the web interface:"
echo "  OLLAMA_MODELS=/mnt/ssd/ollama-models ollama serve &"
echo "  HF_HUB_OFFLINE=1 HF_HUB_CACHE=/mnt/ssd/hf-cache \\"
echo "    python /mnt/ssd/kiwix-rag-project/web.py --db /mnt/ssd/vector_db"
echo ""
echo "Then open http://<pi-hostname>:5000 in a browser."
echo ""
echo "Note: Flask must be installed on the Pi:"
echo "  ~/kiwix-rag/bin/pip install flask"
